...
* Также в хорошем пайплайне мы указали конктъретную версию ОС. Использование конкретной версии ОС гарантирует, что окружение для выполнения пайплайна будет оставаться неизменным. Это помогает избежать неожиданных изменений, которые могут возникнуть при обновлении ОС.
